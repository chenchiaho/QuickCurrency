...
data class Data (
    ...
    @Json(name = "USD") var USD: Double = 1.0,
    ...
    @Json(name = "XRP") val XRP: Double,
    @Json(name = "YER") val YER: Double,
    @Json(name = "ZAR") var ZAR: Double
